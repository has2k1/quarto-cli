  ...
  tests:
    html:
      ensureHtmlElements:
        - []
        -
          - 'script[src="lightbox-off_files/libs/quarto-contrib/glightbox/glightbox.min.js' # make sure that lightbox is enabled
          - 'a.lightbox' # make sure there is no lightbox image        
---
