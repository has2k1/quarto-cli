...
![Elephant](elephant.png){fig-align="right"} <!-- // NOTE:  Must have carriage return or else this will be emitted as an Image and not a Captioned Image --> ![Elephant](elephant.png){fig-align="left"}
