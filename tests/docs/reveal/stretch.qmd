...
## Insert an image specifying `.stretch` explicitly (no caption) {#with-class-no-caption}

With adding stretch feature

![](https://revealjs.com/images/logo/reveal-black-text.svg){.stretch}

## Insert an image specifying `.stretch` explicitly (with caption) {#with-class-caption}

Using the `.stretch` class

![revealjs logo](https://revealjs.com/images/logo/reveal-black-text.svg){.stretch}

## No stretch when more than one image {#more-than-one}
...
On this plot, we have interesting information.

## Using knitr to specify alignment {#knitr-align}
...
## No auto stretch if absolute is used {#absolute}
...
## No auto stretch if image is inside links {#link}
